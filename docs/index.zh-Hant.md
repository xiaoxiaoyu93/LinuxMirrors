...
=== ":linux:{ .middle } GNU/Linux"
    ...
    <button class="md-clipboard" data-clipboard-text="bash &lt;(curl -sSL https://raw.githubusercontent.com/xiaoxiaoyu93/LinuxMirrors/main/ChangeMirrors.sh)" title="複製"></button>
...
=== ":simple-docker:{ .lg .middle style="color: #1d63ed"} Docker"
    ...
    <button class="md-clipboard" data-clipboard-text="bash &lt;(curl -sSL https://raw.githubusercontent.com/xiaoxiaoyu93/LinuxMirrors/main/DockerInstallation.sh)" title="複製"></button>
